...
urlpatterns = [
    ...
    path('enable-ga-auth/', views.EnableGaAuth.as_view(), name='enable-ga-auth'),
    path('disable-ga-auth/', views.DisableGaAuth.as_view(), name='disable-ga-auth'),
    ...
    path('disable-two-step-auth/<int:user_id>/', views.DisableTwoStepAuthByStaff.as_view()),
